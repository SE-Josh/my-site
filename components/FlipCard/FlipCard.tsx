  ...
  return (
    <div className="p-10 w-full h-full md:p-0 md:w-64 md:h-140 [perspective:2000px]">
      ...
      >
        {/* Front Side */}
        <div
          className="card absolute inset-0 flex flex-col items-center justify-center gap-3 rounded-box bg-base-200 [backface-visibility:hidden] cursor-pointer"
              ...
              <li key={item.key}>
                <a
                  className={`transition-all duration-300 ease-in-out ${
                    activeTab === item.key ? "menu-active" : ""
                  }`}
